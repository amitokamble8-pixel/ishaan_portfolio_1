...
export function Home() {
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead title="Work Experience" eyebrow="Hands-On Experience" />
      ...
      <section className="section">
        <SectionHead title="Featured Projects" eyebrow="Explored & Explained" />
        <div className="grid-2">
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="Scottish High International School" />
      ...
      <SubHead title="Education" eyebrow="Gurugram, India" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Work() {
  ...
  return (
    <section className="section">
      <PageHead title="Work Experience" eyebrow="Hands-On Experience" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Featured Projects" eyebrow="Explored & Explained" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Volunteering() {
  usePageMeta(`Leadership & Collaboration | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Leadership & Collaboration" eyebrow="Leading Through Technical Curiosity" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
